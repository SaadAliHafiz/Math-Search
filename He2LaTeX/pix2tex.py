...
def initialize(arguments=None):
    if arguments is None:
        arguments = Munch({'config': 'settings/config.yaml', 'checkpoint': 'checkpoints/mixed/mixed_e01.pth', 'no_cuda': True, 'no_resize': False})
...
if __name__ == "__main__":
    ...
    parser.add_argument('-m', '--checkpoint', type=str, default='checkpoints/mixed/mixed_e01.pth')
